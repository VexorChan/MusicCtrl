...
- 当前安装 EXE 从运行时提交 `ba89f0c36e55b4333690935daa034bd823f176de` 构建；该提交已推送并远端回读一致。准确解释器、PyInstaller 和依赖版本以安装目录中的 `BUILD-INFO.txt` 为准；其后的交付记录提交仅含文档，不改变 EXE 来源。
...
- 2026-08-10 歌单选择、v4 关系、媒体元数据和组合文件状态修复从最终运行时 `ba89f0c` 重新构建并安装；EXE SHA-256 为 `4098EF968421DA0EE25545AEC09EB411E96861ABEABDAC6403D24E69787AD070`，225 条清单及 226 个安装文件回读一致，桌面快捷方式验证通过。
