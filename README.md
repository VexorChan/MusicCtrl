...
面向 Windows 11 的本地音乐文件整理工具。M1 高保真 UI 原型和 P1 只读扫描、SQLite 索引已经完成，当前正在开发 **P2 歌曲信息与安全重命名**。
...
- P2-A 只读取已索引文件的 Title/Artist 并生成可编辑预览，不修改媒体；P2-B 在用户确认后执行同目录安全重命名；P2-C 才通过候选副本写入并验证 MP3、FLAC、M4A 元数据。
